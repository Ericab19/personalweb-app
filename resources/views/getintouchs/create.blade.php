...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="{{ route('getintouchs.store') }}" method="POST">
            @csrf
             ...
             <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:150px" name="whatsupp" placeholder="Whatsupp"></textarea>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Jam Kerja:</strong>
                        <input type="text" name="jamkerja" class="form-control" placeholder="Jam Kerja">
                    </div>
                </div>
