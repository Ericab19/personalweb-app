    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mt-5 mb-5">
            <div class="col-lg-12 margin-tb">
                <div class="float-left">
                    <h2>Get In Touch Table</h2>
                </div>
                <div class="float-right">
                    <a class="btn btn-success" href="{{ route('getintouchs.create') }}"> Create Get In Touch</a>
                </div>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td class="text-center">{{ $getintouch->id }}</td>
                <td>{{ $getintouch->alamat }}</td>
                <td>{{ $getintouch->email }}</td>
                <td>{{ $getintouch->whatsupp }}</td>
                <td>{{ $getintouch->jamkerja }}</td>
                <td class="text-center">
                    <form action="{{ route('getintouchs.destroy',$getintouch->id) }}" method="POST">
        
                        <a class="btn btn-info btn-sm" href="{{ route('getintouchs.show',$getintouch->id) }}">Show</a>
        
                        <a class="btn btn-primary btn-sm" href="{{ route('getintouchs.edit',$getintouch->id) }}">Edit</a>
