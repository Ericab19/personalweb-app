...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="{{ route('getintouchs.update',$getintouch->id) }}" method="POST">
            @csrf
            @method('PUT')
             ...
             <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" value="{{ $getintouch->alamat }}" class="form-control" placeholder="Alamat">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Email:</strong>
                        <input type="text" name="email" value="{{ $getintouch->email }}" class="form-control" placeholder="Email">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Whatsupp:</strong>
                        <textarea class="form-control" style="height:150px" name="whatsupp" placeholder="Whatsupp">{{ $getintouch->whatsupp }}</textarea>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Jam Kerja:</strong>
                        <input type="text" name="jamkerja" value="{{ $getintouch->jamkerja }}" class="form-control" placeholder="Jam Kerja">
                    </div>
                </div>
